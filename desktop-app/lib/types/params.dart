...
class Params {
  ...
  String getResolutionToString() {
    return "default res"; // video.resolution.toPrettyString();
  }

  String getChannelToString() {
    return "super stero"; //audio.channel.toPrettyString();
  }

  String getBitrateToString() {
    return "crazy bit rate"; //bitrateToPrettyString(audio.bitrate);
  }

  String getSampleRateToString() {
    return "mad sample rate"; //audio.sampleRate.toPrettyString();
  }
}
